...
public class BackupLog{
	...
	public static void main(String[] a) throws Exception{
		...
		try {
			...
			backupFile = new File(prop.getProperty("backup.log.folder")+File.separator+prop.getProperty("database.name")+"_"+System.currentTimeMillis()+".trn");
			
			backupCommand = "BACKUP LOG ["+prop.getProperty("database.name")+"] TO  DISK = N'"+backupFile.getAbsolutePath()+"' WITH NOFORMAT, INIT, SKIP, REWIND, NOUNLOAD,  STATS = 10";
